...
namespace ZoDream.Shared.WebType.Converters
{
    ...
    {
        public static Lazy<TripleEncodingTable> Instance = new();

        private readonly List<TripleEncodingRecord> _items = [];
        ...
        public TripleEncodingTable()
        {
            ...
            //8                                           1024           -
            //9                                           1024           +
            BuildRecords(2, 0, 8, null, [0, 256, 512, 768, 1024]); //2*5
            ...
            //18                                1024              -
            //19                                1024              +
            BuildRecords(2, 8, 0, [0, 256, 512, 768, 1024], null); //2*5
            ...
            //34                                          49      -      +
            //35                                          49      +      +  
            BuildRecords(2, 4, 4, [1], [1, 17, 33, 49]);// 4*4 => 16 records
            ...
            //50                                          49      -      +
            //51                                          49      +      +
            BuildRecords(2, 4, 4, [17], [1, 17, 33, 49]);// 4*4 => 16 records
            ...
            //66                                          49      -      +
            //67                                          49      +      +
            BuildRecords(2, 4, 4, [33], [1, 17, 33, 49]);// 4*4 => 16 records
            ...
            //82                                          49      -     +
            //83                                          49      +     +
            BuildRecords(2, 4, 4, [49], [1, 17, 33, 49]);// 4*4 => 16 records
            ...
            //94                                         513      -     +
            //95                                         513      +     +
            BuildRecords(3, 8, 8, [1], [1, 257, 513]);// 4*3 => 12 records
            ...
            //106                                         513     -      +
            //107                                         513     +      +
            BuildRecords(3, 8, 8, [257], [1, 257, 513]);// 4*3 => 12 records
            ...
            //118                                         513     -      +
            //119                                         513     +      +
            BuildRecords(3, 8, 8, [513], [1, 257, 513]);// 4*3 => 12 records
            ...
            //122                                                 -      +
            //123                                                 +      +
            BuildRecords(4, 12, 12, [0], [0]); // 4*1 => 4 records
            ...
            //126                                                 -      +
            //127                                                 +      + 
            BuildRecords(5, 16, 16, [0], [0]);// 4*1 => 4 records
        }

        public TripleEncodingRecord this[int index] => _items[index];
